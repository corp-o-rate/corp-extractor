...
<table>
  ...
  <tbody>
    <tr>
      <td><code>extract_statements(text, options?, server_url?)</code></td>
      <td><code>ExtractionResult</code></td>
      <td>Main extraction function. Returns structured statements with confidence scores. Pass <code>server_url</code> to delegate to a running server.</td>
    </tr>
    <tr>
      <td><code>extract_statements_as_json(text, options?, indent?, server_url?)</code></td>
      <td><code>str</code></td>
      <td>Returns extraction result as a JSON string.</td>
    </tr>
    <tr>
      <td><code>extract_statements_as_xml(text, options?, server_url?)</code></td>
      <td><code>str</code></td>
      <td>Returns raw XML output from the model.</td>
    </tr>
    <tr>
      <td><code>extract_statements_as_dict(text, options?, server_url?)</code></td>
